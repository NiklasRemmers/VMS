...
from vms.infra.odt_processor import (
...
# Bundled ODT templates live in <repo>/assets (this module sits at vms/infra/).
...
BUNDLED_TEMPLATES = {
    'leihvertrag': os.path.join(ASSETS_DIR, 'template.odt'),
    'rechnung': os.path.join(ASSETS_DIR, 'template_rechnung.odt'),
    'umbuchung': os.path.join(ASSETS_DIR, 'template_umbuchung.odt'),
}
...
# call sites: app.py generate_pdf() and invoice_routes.py api_download_invoice().
